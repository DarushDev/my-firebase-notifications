        ...
        btnInvite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new AppInviteInvitation.IntentBuilder("Invitation Title")
                        ...
                        .setDeepLink(Uri.parse("https://p34zx.app.goo.gl/iNhr"))
                        .setCustomImage(Uri.parse("https://www.w3schools.com/css/img_lights.jpg"))
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_INVITE) {
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Sending failed or it was canceled", Toast.LENGTH_SHORT).show();
            }
        }
    }
